...
@Rule(key = "InfogainRecomendationAvoidMethodWithSameTypeInArgument",
...
public class InfogainCustomMethodParameterRule extends IssuableSubscriptionVisitor {
	...
	private final String MESSAGE="Infogain Recomends Avoiding Method With Same return Type and Argument";
	/**
	 * @author Rudhra Koul This method is used to identify the type of element like
	 *         method ,constructor,catch block etc to apply the rule on
	 */
	@Override
	...
	/**
	 * @author Rudhra Koul This is the actual rule that is implemented
	 */
	@Override
